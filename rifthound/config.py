...
'recon':{'depth':3,'max_urls':50000,'reconner_output':'','dnsx':{'enabled':False},'waymore':{'enabled':False},'arjun':{'enabled':False},'bbot':{'enabled':False,'preset':'subdomain-enum','require_flags':['passive']},'jsattack':{'enabled':False},'service_correlation':{'enabled':False,'top_ports':100,'metasploit_search':True,'nmap_vuln':False}},
